...
#define MCP251XFD_REG_FIFOCON(x)              (0x50 + 0x0C * (x))
...
#define MCP251XFD_REG_FIFOSTA(x)              (0x54 + 0x0C * (x))
...
#define MCP251XFD_REG_FIFOUA(x)               (0x58 + 0x0C * (x))

#define MCP251XFD_REG_BYTE_FLTCON(m)          (0x01D0 + m)
#define MCP251XFD_REG_BYTE_FLTCON_FBP_MASK    GENMASK(4, 0)
#define MCP251XFD_REG_BYTE_FLTCON_FLTEN       BIT(7)

#define MCP251XFD_REG_FLTOBJ(x)               (0x01F0 + 0x08 * (x))
...
#define MCP251XFD_REG_FLTMASK(x)              (0x01F4 + 0x08 * (x))
...
/* MCP2517/18FD SFR */
#define MCP251XFD_REG_OSC                      0x0E00
...
#define MCP251XFD_REG_IOCON                    0x0E04
...
#define MCP251XFD_REG_CRC                      0x0E08
...
#define MCP251XFD_REG_ECCCON                   0x0E0C
...
#define MCP251XFD_REG_ECCSTAT                  0x0E10
...
#define MCP251XFD_REG_DEVID                    0x0E14 /* MCP2518FD only */
...
#define MCP251XFD_REG_FIFOCON_TO_STA(addr) (addr + 0x04)

#define MCP251XFD_REG_FLTCON(m) (0x01D0 + m)
