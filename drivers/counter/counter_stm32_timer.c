...
static uint32_t (*const get_timer_capture[TIMER_MAX_CH])(TIM_TypeDef const* TIMx) = {
    LL_TIM_IC_GetCaptureCH1, LL_TIM_IC_GetCaptureCH2,
    LL_TIM_IC_GetCaptureCH3, LL_TIM_IC_GetCaptureCH4,
};

static uint32_t (*const get_over_capture[TIMER_MAX_CH])(TIM_TypeDef const* TIMx) = {
    LL_TIM_IsActiveFlag_CC1OVR, LL_TIM_IsActiveFlag_CC2OVR,
    LL_TIM_IsActiveFlag_CC3OVR, LL_TIM_IsActiveFlag_CC4OVR,
};

static void (*const clear_over_capture[TIMER_MAX_CH])(TIM_TypeDef* TIMx) = {
