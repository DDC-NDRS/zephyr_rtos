...
cy_rslt_t _i2c_abort_async(struct device const* dev) {
...
static void ifx_handle_target_read_event(struct device const* dev) {
...
static void ifx_handle_target_events(struct device const* dev, uint32_t event) {
    const struct ifx_cat1_i2c_config* const config = dev->config;
    struct ifx_cat1_i2c_data* data = dev->data;
    struct i2c_target_callbacks const* target_callbacks = data->p_target_config->callbacks;
...
void ifx_cat1_i2c_register_callback(struct device const* dev,
 ...
 */
static int _i2c_set_peri_divider(struct device const* dev, uint32_t freq,
                                 bool is_target_mode) {
...
static int _i2c_controller_transfer_async(struct device const* dev, uint16_t address,
                                          void const* tx, size_t tx_size, void* rx,
                                          size_t rx_size) {
    struct ifx_cat1_i2c_data* data = dev->data;
    const struct ifx_cat1_i2c_config* const config = dev->config;
...
static int ifx_cat1_i2c_transfer(struct device const* dev, struct i2c_msg* msg, uint8_t num_msgs,
                                 uint16_t addr) {
...
static int ifx_cat1_i2c_init(struct device const* dev) {
    struct ifx_cat1_i2c_data* data = dev->data;
    const struct ifx_cat1_i2c_config* config = dev->config;
    int ret;
    cy_rslt_t result;
...
#ifdef CONFIG_PM_DEVICE
static int ifx_cat1_i2c_pm_action(struct device const* dev, enum pm_device_action action) {
    struct ifx_cat1_i2c_data* const data = dev->data;
    struct ifx_cat1_i2c_config const* const config = dev->config;
...
void _i2c_free(struct device const* dev) {
    struct ifx_cat1_i2c_data* data = dev->data;
    const struct ifx_cat1_i2c_config* const config = dev->config;
...
static int ifx_cat1_i2c_target_register(struct device const* dev, struct i2c_target_config* cfg) {
...
static void ifx_cat1_i2c_isr_handler(struct device const* dev) {
    struct ifx_cat1_i2c_data* data = (struct ifx_cat1_i2c_data*)dev->data;
    const struct ifx_cat1_i2c_config* const config = dev->config;
...
void ifx_cat1_i2c_cb_wrapper(struct device const* dev, uint32_t event) {
    struct ifx_cat1_i2c_data* const data = dev->data;
...
#define I2C_CAT1_INIT_FUNC(n)                                   \
    static void ifx_cat1_i2c_irq_config_func_##n(struct device const* dev) { \
...
static void zephyr_gtest_i2c_ifx_cat1_reg_init(struct device const* dev,
                                               struct ifx_cat1_i2c_data* data,
