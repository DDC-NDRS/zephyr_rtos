...
#include "rmt/include/driver/rmt_tx.h"

/* 10 MHz resolution, 1 tick = 0.1 μs (led strip needs a high resolution) */
#define RMT_LED_STRIP_RESOLUTION_HZ 10000000
#define RMT_LED_STRIP_GPIO_NUM      48

static const rmt_symbol_word_t ws2812_zero = {
    .level0 = 1,
    .duration0 = (uint16_t)((0.3F * RMT_LED_STRIP_RESOLUTION_HZ) / 1000000),    // T0H = 0.3 μs
    .level1 = 0,
    .duration1 = (uint16_t)((0.9F * RMT_LED_STRIP_RESOLUTION_HZ) / 1000000),    // T0L = 0.9 μs
};

static const rmt_symbol_word_t ws2812_one = {
    .level0 = 1,
    .duration0 = (uint16_t)((0.9F * RMT_LED_STRIP_RESOLUTION_HZ) / 1000000),    // T1H = 0.9 μs
    .level1 = 0,
    .duration1 = (uint16_t)((0.3F * RMT_LED_STRIP_RESOLUTION_HZ) / 1000000),    // T1L = 0.3 μs
};

// Reset low voltage time above 50 μs
static const rmt_symbol_word_t ws2812_reset = {
    .level0 = 1,
    .duration0 = (uint16_t)(((50 / 2) * RMT_LED_STRIP_RESOLUTION_HZ) / 1000000),
    .level1 = 0,
    .duration1 = (uint16_t)(((50 / 2) * RMT_LED_STRIP_RESOLUTION_HZ) / 1000000),
};
