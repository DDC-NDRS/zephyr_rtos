 ...
 * consuming them.
 */
NET_BUF_POOL_FIXED_DEFINE(sync_evt_pool, CONFIG_BT_BUF_SYNC_EVT_POOL_COUNT, SYNC_EVT_SIZE, BT_ZERO_LEN_ARRAY, NULL);
...
NET_BUF_POOL_FIXED_DEFINE(evt_pool, CONFIG_BT_BUF_EVT_RX_COUNT, BT_BUF_EVT_RX_SIZE, BT_ZERO_LEN_ARRAY,
			  evt_pool_destroy);
#else
