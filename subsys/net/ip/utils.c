...
char* net_sprint_addr(net_sa_family_t af, void const* addr) {
#define NBUFS 3
...
char* z_impl_net_addr_ntop(net_sa_family_t family, void const* src,
...
char* z_vrfy_net_addr_ntop(net_sa_family_t family, void const* src,
                           char* dst, size_t size) {
...
int z_impl_net_addr_pton(net_sa_family_t family, char const* src,
                         void* dst) {
    if (family == NET_AF_INET) {
...
#if defined(CONFIG_USERSPACE)
int z_vrfy_net_addr_pton(net_sa_family_t family, char const* src,
                         void* dst) {
