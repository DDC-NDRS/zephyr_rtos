...
static void settings_nvs_cache_add(struct settings_nvs* cf, char const* name,
                                   uint16_t name_id) {
...
static uint16_t settings_nvs_cache_match(struct settings_nvs* cf, char const* name,
